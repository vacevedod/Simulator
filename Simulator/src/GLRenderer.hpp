...
namespace VarjoExamples {
    class GLColorRenderTexture final : public Renderer
    {
    public:
    ...
    private:
        ...
        void queueObjects(const std::vector<ObjectRenderData>& matrices) override;
        void dispatchDraws() override;
        ...
        GLuint createInstanceBuffer();
        GLuint createUniformBuffer();
        void useInstanceBuffer();
         ...
         * This is requred for the OpenGL context.
         */
        void createDummyWindow();
        void createOcclusionMesh();
        ...
        int32_t m_occlusionMeshVertexes{};
